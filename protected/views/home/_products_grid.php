...
if ($products) {
    foreach ($products as $product) {
        ...
        <div class="span3 img_container shan">
        	<div class="prod_div">
            <?php
            ...
            <div class="item-cap">
                ...
                <a href="<?php echo Yii::app()->request->baseUrl; ?>/productDetails-<?php echo $product->slug; ?>" style="text-align: right;" class="price">
            ...
            <?php if ($show_shop) { ?>
                <div class="item-fav" id="itm_<?php echo $product->id; ?>" chk='true'>
                    <div class="fav-left">
                        ...
                        <a href="#" class="date"><?php echo Helper::ago(strtotime($product->start_date),$product->end_date); ?></a>
                    </div>
            ...
            <div class="item-share">
                <div class="items-div">
                    ...
                    <a class='stLarge' target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo $product->title?>&via=WhereWeStyle&url=<?php echo Yii::app()->getBaseUrl(true); ?>/home/productDetails/<?php echo $product->slug; ?>&image=<?= Yii::app()->getBaseUrl(true); ?>/media/products/original/<?= $product->main_image; ?>" ></a>-->
                    ...
                    -->
                                ...
                                <!--<a data-toggle="tooltip" title="Like" class="facebook" href="https://www.facebook.com/dialog/feed?app_id=409482105858611&display=popup&picture=<?= Yii::app()->getBaseUrl(true); ?>/media/products/original/<?= $product->main_image; ?>&description=I liked this fabulous item at <?php echo Yii::app()->getBaseUrl(true); ?>/home/productDetails/<?php echo $product->slug; ?>&caption=<?=Yii::app()->request->getBaseUrl('webroot')?>&name=<?php echo $product->title; ?>&redirect_uri=<?php echo Yii::app()->getBaseUrl(true); ?>/home/productDetails/<?php echo $product->slug; ?>&link=<?php echo Yii::app()->getBaseUrl(true); ?>/home/productDetails/<?php echo $product->slug; ?>"></a>-->
