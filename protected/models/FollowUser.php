 ...
 *
 * The followings are the available columns in table 'follow_user':
 * @property integer $id
 ...
 * @property User $user
 */
class FollowUser extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return FollowUser the static model class
     */
    public $selection;
    public $userList;
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, user_id, followers', 'safe', 'on' => 'search'),
        );
    }
