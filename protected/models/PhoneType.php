 ...
 */
class PhoneType extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'userDetails' => array(self::HAS_MANY, 'UserDetails', 'phone_type'),
		);
	}
	...
	{
		return CHtml::listData(PhoneType::model()->findAll(array('order'=>'title ASC')),'id','title');
	}
